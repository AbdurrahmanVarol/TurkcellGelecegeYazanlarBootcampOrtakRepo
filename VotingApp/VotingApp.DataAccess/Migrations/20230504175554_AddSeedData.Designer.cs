...
namespace VotingApp.DataAccess.Migrations
{
    ...
    [Migration("20230504175554_AddSeedData")]
            ...
            modelBuilder.Entity("VotingApp.Entities.Option", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 883, DateTimeKind.Local).AddTicks(7016),
                            PollId = 1,
                            Value = "Seçenek1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 883, DateTimeKind.Local).AddTicks(7027),
                            PollId = 1,
                            Value = "Seçenek2"
                        });
                });
            ...
            modelBuilder.Entity("VotingApp.Entities.Poll", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 883, DateTimeKind.Local).AddTicks(9731),
                            CreatedById = 1,
            ...
            modelBuilder.Entity("VotingApp.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(251),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(259),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(262),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(265),
            ...
            modelBuilder.Entity("VotingApp.Entities.Vote", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(2189),
                            OptionId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(2194),
                            OptionId = 1,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(2196),
                            OptionId = 1,
                            UserId = 3
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 5, 4, 20, 55, 54, 885, DateTimeKind.Local).AddTicks(2197),
                            OptionId = 2,
                            UserId = 4
                        });
                });
